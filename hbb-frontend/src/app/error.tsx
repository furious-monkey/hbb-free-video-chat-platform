...
const Error = () => {
  ...
  return (
    <div className="relative bg-[#E688A3] min-h-screen h-screen py-12">
      <div className="relative bg-white/[0.16]  max-w-[92%] h-full flex justify-center items-center mx-auto rounded-3xl">
        <div className="md:w-2/4 flex flex-col items-center justify-between">
         <Image
            src="/assests/error.svg"
            alt="no live active" width={172} height={222}
