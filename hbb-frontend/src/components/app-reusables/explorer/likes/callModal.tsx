...
const CallModal = ({ isOpen, onClose, item }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col bg-base1 rounded-[15px] w-[93%] md:w-[60%] h-[82dvh] md:h-[80dvh] relative p-5">
        {/* close button */}
        <Button
        ...
        <div>
          <p className="border-b w-full border-[#ffffff50] text-[15px] md:text-[18px] mt-4 md:mt-5 mb-5 md:mb-5 pb-3">
            Request call
          </p>
          <div className="flex justify-center items-center w-full h-[60dvh] md:h-[60dvh]">
            <div className="flex flex-col items-center justify-center h-full w-[100%] md:w-[80%]">
              <div className="bg-white rounded-[15px] shadow-custom-shadow-component h-full p-2 md:p-5 w-full">
                <h2 className="text-[15px] text-center font-[500] mb-3 md:mb-5 text-black">
                  Change time
                </h2>
