          ...
          <div className="flex-col flex gap-5 lg:gap-6">
            {paymentData.map((data) => (
              <div
                ...
                className={`w-full flex justify-between items-center gap-18 cursor-pointer hover:bg-[#94E3FF30]`}
              >
                <div className="">
...
const paymentData: SecurityData[] = [
  {
    label: "cardInfo",
    heading: "Card info",
    body: "Access your card information here",
  },
  {
    label: "transactionHistory",
    heading: "Transaction history",
    body: "My transaction history",
  },
];
