...
function Calendar({
  ...
  const renderYearPicker = () => (
    <div className="flex justify-center mb-4">
      <select
        ...
        className="border border-profile p-1 text-sm text-white bg-base1"
      >
  ...
  const focusYearDate = new Date(selectedYear, new Date().getMonth());
    ...
    <div>
      ...
      <DayPicker
        ...
        classNames={{
          ...
          day_selected:
            "bg-base2 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-base2 focus:text-primary-foreground",
